...
private:
    ...
    // Servo settings
    static constexpr uint16_t SERVO_MIN_PULSE = 1000;  // Microseconds (closed mouth)
    static constexpr uint16_t SERVO_MAX_PULSE = 1500;  // Microseconds (open mouth)
    ...
    static constexpr int SERVO_UPDATE_DELAY_US = 20000;  // 20ms
    static constexpr double MAX_SERVO_SPEED = 50.0;  // Max pulse change per update
